...
let userSchema = new mongoose.Schema({
  ...
  phoneNumber: {type: mongoose.Schema.Types.String, required: REQUIRED_VALIDATION_MESSAGE},
  isBlocked: {type: mongoose.Schema.Types.Boolean, default: false},
  avatar: {type: mongoose.Schema.Types.String, default: 'https://i.imgur.com/itElfV3.jpg'},
