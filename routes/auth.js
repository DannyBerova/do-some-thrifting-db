...
function validateSignupForm (payload) {
  ...
  if (!payload || typeof payload.phoneNumber !== 'string' || payload.phoneNumber.length < 9 || payload.phoneNumber.length > 20) {
    isFormValid = false
    errors.lastName = 'Phone Number must be at least 9 symbols and less than 20 symbols.'
  }
...
router.post('/register', (req, res, next) => {
  ...
  if (!validationResult.success) {
    ...
    const {  username, password,email, firstName, lastName, phoneNumber, avatar } = req.body;
